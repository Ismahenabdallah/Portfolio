        ...
        <div className='flex flex-col xl:flex-row gap-24'>
          ...
          <div className='flex flex-col items-center text-center lg:items-start lg:text-left'>
            ...
            <div className='flex justify-between '>
              ...
              <a  href="cv ismahen abdallah.pdf" target="_blank" download><button className='border border-gray-600 text-white w-32 p-1 mt-8  hover:bg-accent-hover'>Download Cv</button></a>
